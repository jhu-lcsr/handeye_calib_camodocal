...
public:
  ...
  ///
  /// Given two vectors with N equivalent but changing transforms in each index
  /// i,
  ...
  /// size N
  /// @param rvecs2 vector of size N with each element containing the unit axis
  /// and angle for the second transform with size N
  /// @param tvecs2 vector of the translation for the second transform with size
  /// N
  ///
